    ...
    <section className="relative pt-12 pb-20 md:pt-20 md:pb-32 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg sm:text-xl text-slate-300 font-normal leading-relaxed mb-10">
          TruthShield helps you detect potentially AI-generated or manipulated media, understand why it was flagged, and verify its source and context before sharing it.
        </p>
        ...
        {/* Security & Forensics Trust Metrics / Attributes */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto pt-8 border-t border-slate-800/80 text-left">
          <div className="p-4 rounded-xl bg-slate-900/40 border border-slate-800/60">
            <div className="flex items-center gap-2 text-emerald-400 mb-1">
              ...
              <span className="text-xs font-mono font-semibold uppercase text-slate-400">Integrity</span>
            </div>
            <p className="text-sm font-medium text-slate-200">Zero-Tamper Check</p>
            <p className="text-xs text-slate-400 mt-0.5">Hash & EXIF validation</p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-900/40 border border-slate-800/60">
            ...
            <p className="text-sm font-medium text-slate-200">Explainable Forensics</p>
            <p className="text-xs text-slate-400 mt-0.5">No black-box guesses</p>
          </div>

          <div className="p-4 rounded-xl bg-slate-900/40 border border-slate-800/60">
            <div className="flex items-center gap-2 text-teal-400 mb-1">
              <Sparkles className="w-4 h-4" />
              <span className="text-xs font-mono font-semibold uppercase text-slate-400">Multi-Model</span>
            </div>
            <p className="text-sm font-medium text-slate-200">Hive + Gemini Ready</p>
            <p className="text-xs text-slate-400 mt-0.5">Pipeline architecture</p>
          </div>
        </div>
